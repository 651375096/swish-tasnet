...
def readLvm2(dir):
    ...
    lvm_data = lvm_file['data']
    lvm_data = np.array(lvm_data)  # 装入数组
    return lvm_data[:, 0:1],lvm_data[:, 1:2],len(lvm_data[:, 1:2])
...
# database_path ="/home/chenyang/Dataset/cmm-data/"
# tt_mix_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/tt/mix/"
# tr_mix_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/tr/mix/"
# cv_mix_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/cv/mix/"
#
# tt_s1_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/tt/s1/"
# tr_s1_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/tr/s1/"
# cv_s1_path="/home/chenyang/wave-tasnet/voice_data/wav_cmm_all/cv/s1/"
#
...
#             aaa,bbb,aaa_cd = readLvm2(subset111_folder)
...
#                        bbb, fmt='%.05f')
            ...
            #         s1_path = tr_s1_path
            #
            #     huatu(aaa[aaa_cd * ai // slic_cs:aaa_cd * (ai + 1) // slic_cs],"cmm——mix——ori")
            #     huatu(bbb[aaa_cd * ai // slic_cs:aaa_cd * (ai + 1) // slic_cs],"cmm--s1-ori")
