...
wav_name="wav-sjx"
wjj_temp="tmp-sjx"
pre_name="ICMP报文1.csv0.txt"

mix_path="./voice_data/"+wav_name+"/tt/mix/"+pre_name
mix=np.loadtxt(mix_path)
huatu(mix,wjj_temp+"mix")

s1_ori_path="./voice_data/"+wav_name+"/tt/s1/"+pre_name
s1_ori=np.loadtxt(s1_ori_path)
huatu(s1_ori,wjj_temp+"s1_ori")

s2_ori_path="./voice_data/"+wav_name+"/tt/s2/"+pre_name
s2_ori=np.loadtxt(s2_ori_path)
huatu(s2_ori,wjj_temp+"s2_ori")

s1_path="./exp/"+wjj_temp+"/out/signal/estimate/s1/"+pre_name+  ".txt"
s1=np.loadtxt(s1_path)
huatu(s1,wjj_temp+"-fl-s1")

s2_path="./exp/"+wjj_temp+"/out/signal/estimate/s2/"+pre_name+  ".txt"
s2=np.loadtxt(s2_path)
huatu(s2,wjj_temp+"fl-s2")