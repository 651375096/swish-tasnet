...
def handleBinarization(data,input_standard,deviation=0,way=0):
    ...
    if isNumber(input_standard):
        ...
        # standard = -0.015
        standard = -0.000001
    elif input_standard == "pre_out_taiyuan_blue_dataset":
        # standard =np.max(bin_data)/5
        # standard = 0.001
        # standard = -0.001
        # standard = -0.015
...
# aac=read4CSV_taiyuan_vga2_mix("./voice_data/tek0002单通道混合主机总线pptALL.csv")
# print("长度",len(aac))
# for ai in range(2):
#     np.savetxt("./voice_data/wav/tt/mix/mixtest50000000"+str(ai)+".txt",aac[ai*50000000:(ai+1)*50000000])
#     np.savetxt("./voice_data/wav/tt/s1/mixtest50000000"+str(ai)+".txt",aac[ai*50000000:(ai+1)*50000000])
#     np.savetxt("./voice_data/wav/tt/s2/mixtest50000000"+str(ai)+".txt",aac[ai*50000000:(ai+1)*50000000])
#     np.savetxt("./voice_data/wav/tt/s3/mixtest50000000"+str(ai)+".txt",aac[ai*50000000:(ai+1)*50000000])


hang_bin_standard="pre_out_taiyuan_dataset"###决定二值化标准
...
# wjj_temp="tmp"
# # wjj_temp="tmp太原11数据vga训练"
#
# pre_name="mixtest10000001"
