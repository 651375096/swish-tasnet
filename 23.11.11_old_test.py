...
zhen_zf=0
hang_zf=0
huatu_cd_start=1111111
huatu_cd_end=1122111

def huatu(data,name):
    y = data[huatu_cd_start:huatu_cd_end]
    x = range(len(y))
    plt.plot(y)
    plt.title(name)
    plt.show()
...
def get_hang_lbo(data_lbo):
    ...
    temp_position = np.where(data_abs[huatu_cd1:huatu_cd2] >0.1)
    print(temp_position)
...
# database_path="/root/autodl-tmp/Dataset_All/308VGA4_in_side"
...
# pre_name="0帧cf_fina1联想a机外网_0.05"
...
#
# wjj_temp="tmp_all_swish_1_14"
# wjj_temp="tmp_all_skipadd0_convblock3_swish_1_14"
# wjj_temp="tmp-308"
# pre_name="1.1-48-4D-7E-BE-C8-651024-768.csv0"
#
# wav_name="wav-308-286"
#
# pre_noise_path="./voice_data/"+wav_name+"/tt/s2/"+pre_name + ".txt"
# pre_noise=np.loadtxt(pre_noise_path)
# huatu(pre_noise,"pre_noise")
#
# pre_mix_path="./voice_data/"+wav_name+"/tt/mix/"+pre_name + ".txt"
# pre_mix=np.loadtxt(pre_mix_path)
#
# pre_blue_s1_path="/home/chenyang/wave00/out/tasnet_test/tasnet_ 5lay_elu_0_0_8.606072343455806e-06/"+pre_name+".txtsignal.txt"
# # pre_blue_s1_path="./exp/"+wjj_temp+"/out/signal/estimate/s1/"+pre_name+  ".txt.txt"
# pre_blue=np.loadtxt(pre_blue_s1_path)
#
# pre_blue_original_s1_path="/home/chenyang/wave-tasnet/voice_data/wav-308-286/tt/s1/"+pre_name+  ".txt"
# # pre_blue_original_s1_path="./voice_data/"+wav_name+"/tt/s1/"+pre_name+  ".txt"
...
# pre_hang_original_s3_path="./voice_data/"+wav_name+"/tt/s3/"+pre_name+".txt"
...
# huatu(pre_hang_original[huatu_cd1:huatu_cd2],"pre_hang_ooriginal")
...
pre_hang_s3_path= "/home/chenyang/wave-tasnet/exp/tmp-308/out/signal/estimate/s3/1.1-48-4D-7E-BE-C8-65800-600.csv0.txt.txt"
pre_hang=np.loadtxt(pre_hang_s3_path)
huatu(abs(pre_hang),"1")
huatu((pre_hang),"2")
