...
#blue_line_black 类型
#读取lvm文件
jmu_frame=readLvm("E:\\Files\\code\\pretreatment\\1024_768_JMU\\1024_768_60_JMU_250MHz.lvm")
black_frame=readLvm("E:\\Files\\code\\pretreatment\\1024_768_JMU\\1024_768_60_black_250MHz.lvm")
blue_frame=readLvm("E:\\Files\\code\\pretreatment\\1024_768_JMU\\1024_768_60_B_250MHz.lvm")
line_frame=readLvm("E:\\Files\\code\\pretreatment\\1024_768_JMU\\1024_768_60_ZHENHANG_250MHz.lvm")
...
drawPicture(var_name(blue_line_pure)+str(fn),blue_line_pure)
#将数据以lvm格式写入
write_dir = "./data/"
ways = "lvm"
writeData(blue_line_pure,ways,write_dir,var_name(blue_line_pure)+str(fn))
...
#方法四
blue_line_noise = black + blue_line_pure
drawPicture(var_name(blue_line_noise)+str(fn),blue_line_noise)
#将数据以lvm格式写入
write_dir = "./data/"
ways = "lvm"
writeData(blue_line_noise,ways,write_dir,var_name(blue_line_noise)+str(fn))
