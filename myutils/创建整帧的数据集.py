...
def getDataset():
    ...
    for fn in range(part_num):
        ...
        #
        # s1_id_wav = sliceData(blue_pure, "wav", filePath_wav1 , s1_id_wav , slice_size,backupPath_wav1)
        # s2_id_wav = sliceData(black, "wav", filePath1_wav2 , s2_id_wav , slice_size,backupPath_wav2)
        # mix_id_wav = sliceData(blue_noise, "wav", filePath1_wav3 , mix_id_wav , slice_size,backupPath_wav3)
        #
        # 制作txt数据集
        ...
        #
        # s1_id_txt = sliceData(blue_pure, "txt", filePath_txt1 , s1_id_txt , slice_size,backupPath_txt1)
        # s2_id_txt = sliceData(black, "txt", filePath_txt2 , s2_id_txt , slice_size,backupPath_txt2)
        # mix_id_txt = sliceData(blue_noise, "txt", filePath_txt3 , mix_id_txt , slice_size,backupPath_txt3)


        writeData(blue_pure, "wav", filePath_wav1 , str(fn))
        writeData(black, "wav",filePath1_wav2 , str(fn))
        writeData(blue_noise, "wav", filePath1_wav3 , str(fn))

        writeData(blue_pure, "lvm", filePath_txt1, str(fn))
        writeData(black, "lvm", filePath_txt2, str(fn))
        writeData(blue_noise, "lvm", filePath_txt3, str(fn))
