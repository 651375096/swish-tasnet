...
def handleBinarization(data,input_standard,deviation=0,way=0):
    ...
    if isNumber(input_standard):
        ...
        # standard = -0.05
        standard = 0.1
    elif input_standard == "pre_out_taiyuan_one_channel":
        # standard =np.max(bin_data)/5
        # standard=1
        # standard = 0.06
        standard = 0.01
        # standard = 0.004
        # standard = 0.0001 ###Write data mixtestdata1.txt
        # standard = -0.001
        # standard = 0.056#Write data mixtestdata5
        # standard = -0.04
...
def getDataset_full_30():
    ...
    for zhen_cs in range(zon_cs):
        ...
        if (subDir2 == "tt/"):
            ...
            # writeData(jmu[int(zon_cs * 0.2)*slice_size:int(zon_cs * 0.3)*slice_size], file_form, filePath_wav_mix_sum, fbl + str(zhen_cs) + "")
...
def pre_out():
    ...
    print(hang_poisition[-5:], "hang_poisition maxlen=", "len=", len(hang_poisition))
...
# #
# subset_folder="/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/ppt太原"
hang_bin_standard="pre_out_blue_taiyuan"
subset_folder="/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/10M-250MHZ-1920-1024"
# for _, folders, files in os.walk(subset_folder):
#     for file_name in sorted(files):
#         if file_name.endswith('.csv'):
#             fbl = file_name
...
# aaa=np.loadtxt("/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/李亮文件/sxlz6.txt")
# a_len=len(aaa)
# bbb=aaa[0:a_len//2]
# ccc=aaa[a_len//2:]
# writeData(bbb, "txt", "./voice_data/wav/tt/mix/",
#               "Write data mixtestdata" )
# writeData(bbb, "txt", "./voice_data/wav/tt/s1/",
#               "Write data mixtestdata" )
# writeData(bbb, "txt", "./voice_data/wav/tt/s2/",
#               "Write data mixtestdata" )
# writeData(bbb, "txt", "./voice_data/wav/tt/s3/",
#               "Write data mixtestdata")



#
# aac=read4CSV_taiyuan_vga2_mix("./voice_data/dataset_taiyuan/ppt太原/单通道混合/tek0003单通道混合屏幕总线pptALL.csv")
# test_cd=1200000
# print("长度",len(aac),"次数",len(aac)//test_cd)
# for ai in range(3,7):
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/mix/",
#               "Write data mixtestdata" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s1/",
#               "Write data mixtestdata" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s2/",
#               "Write data mixtestdata" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s3/",
#               "Write data mixtestdata" + str(ai))
#
# aac=read4CSV_taiyuan_vga2_mix("./voice_data/dataset_taiyuan/ppt太原/单通道混合/tek0002单通道混合主机总线pptALL.csv")
# test_cd=1200000
# print("长度",len(aac),"次数",len(aac)//test_cd)
# for ai in range(3,7):
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/mix/",
#               "Write data tek0002单通道混合主机总线pptALL" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s1/",
#               "Write data tek0002单通道混合主机总线pptALL" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s2/",
#               "Write data tek0002单通道混合主机总线pptALL" + str(ai))
...
# aac=read4CSV_taiyuan_vga2_mix("./voice_data/dataset_taiyuan/ppt太原/单通道混合/tek0004ALL单通道4行字屏幕线.csv")
# test_cd=1200000
# print("长度",len(aac),"次数",len(aac)//test_cd)
# for ai in range(3,7):
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/mix/",
#               "Writedata单通道4行字屏幕线" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s1/",
#               "Writedata单通道4行字屏幕线" + str(ai))
#     writeData((aac[ai  * test_cd:(ai + 1) * test_cd]), "txt", "./voice_data/wav/tt/s2/",
#               "Writedata单通道4行字屏幕线" + str(ai))
...
# wjj_temp="ppt4=ppt1"
wjj_temp="tmp"
hang_bin_standard="pre_out_taiyuan_one_channel" ###决定二值化标准
# pre_name="文字tek0000ALL.csv10"
pre_name="tek00001ALL.csv10"
# hang_bin_standard="pre_out_taiyuan" ###决定二值化标准
# pre_name="tek00004通道pptALL.csv10"
