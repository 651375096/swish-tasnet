...
def handleBinarization(data,input_standard,deviation=0,way=0):
    ...
    if isNumber(input_standard):
        ...
        # standard = 0.004
        standard = -0.001
    elif input_standard == "pre_out_taiyuan_0.07":
        standard = 0.07
    elif input_standard == "pre_out_taiyuan_0.08":
        standard = 0.08
    elif input_standard == "pre_out_taiyuan_-0.08":
        standard = -0.08
    elif input_standard == "pre_out_taiyuan_-0.1":
        standard = -0.1
    elif input_standard == "pre_out_taiyuan_0.001":
        standard = 0.001
    elif input_standard == "pre_out_taiyuan_0.00001":
        standard = 0.00001
    elif input_standard == "pre_out_taiyuan_0":
        standard = 0
    elif input_standard == "pre_out_taiyuan_0.0001":
        standard = 0.0001
...
# database_path = "/home/chenyang/Dataset/VGA/太原VGA数据集/通道1234数据集"
...
#             getDataset_23_9_30train()

# database_path = "/home/chenyang/Dataset/VGA/太原VGA数据集/通道1234数据集valid"
# for _, folders, files in os.walk(database_path):
#     for file_name in sorted(files):
#         if file_name.endswith('.csv'):
#             fbl = file_name
...
#             line_frame, blue_frame, jmu_frame = read4CSV_taiyuan_vga2_usb(subset111_folder)
#             zon_cd = len(jmu_frame['frame'])
#             getDataset_23_9_30valid()

# wj_path="/home/chenyang/Dataset/VGA/太原VGA数据集/单通道数据集/"
# # wj_name="无运放ppt1单通道tek0001ALL"
# for _, folders, files in os.walk(wj_path):
#     for file_name in sorted(files):
#         if file_name.endswith('.csv'):
#             fbl = file_name
#             print("fbl", fbl)
#             aac = read4CSV_taiyuan_vga2_mix(wj_path + file_name)
#             test_cd = 1200000
...
#
database_308VGA_test_path ="/home/chenyang/Dataset/VGA/308VGA4_in_side/单通道"
for _, folders, files in os.walk(database_308VGA_test_path):
    for track_name in sorted(folders):
        print("track_name",track_name)
        subset_folder = op.join(database_308VGA_test_path, track_name)
        print(subset_folder ,"subset_folder ")
        for _, folders, files in os.walk(subset_folder):
            for file_name in sorted(files):
                if file_name.endswith('.csv'):
                    fbl=track_name+"_"+file_name
                    print("fbl",fbl)
...
# hang_bin_standard="308VGA4_inside"###决定二值化标准
# database_path ="/home/chenyang/Dataset/VGA/308VGA4_in_side/验证集"
# for _, folders, files in os.walk(database_path):
#     for track_name in sorted(folders):
#         print("track_name",track_name)
...
# # hang_bin_standard="pre_out_taiyuan_0.001"
# # hang_bin_standard="pre_out_taiyuan_0.0001"
#
# # hang_bin_standard="pre_out" ###决定二值化标准
# wjj_temp="tmp"
# pre_name="1024-768.csv1"
# fbl=pre_name
