...
from ..masknn.attention import SepFormer, SepFormer2
from asteroid.models.base_models import BaseEncoderMaskerDecoder


class SepFormerTasNet(BaseEncoderMaskerDecoder):
    """SepFormer separation model, as described in [1].
    ...
    Args:
        ...
        n_repeats (int): Number of repeats. Defaults to 2.
        k_repeats (int): Number of intra/inter repeats. Defaults to 4.
...
class SepFormer2TasNet(BaseEncoderMaskerDecoder):
    """SepFormer separation model, as described in [1].
