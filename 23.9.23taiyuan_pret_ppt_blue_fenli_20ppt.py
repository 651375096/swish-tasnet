...
#
# #
# wj_path="./voice_data/dataset_taiyuan/ppt太原/单通道混合/"
...
#                           file_name + str(ai))
wj_path="./voice_data/dataset_taiyuan/ppt太原1920-1024/单通道混合/"
file_name="太原PPT单通道1号tek0020ALL"
ai=20
aac = read4CSV_taiyuan_vga2_mix(wj_path + file_name+".csv")
wj_len=len(aac)
writeData((aac[0:wj_len//2]), "txt", "./voice_data/wav/tt/mix/",
                          file_name + str(ai))
writeData((aac[0:wj_len//2]), "txt", "./voice_data/wav/tt/s1/",
                          file_name + str(ai))
writeData((aac[0:wj_len//2]), "txt", "./voice_data/wav/tt/s2/",
                          file_name + str(ai))
writeData((aac[0:wj_len//2]), "txt", "./voice_data/wav/tt/s3/",
                          file_name + str(ai))
...
# wjj_temp="tmp"
# pre_name="太原PPT4通道3号tek0014ALL.csv10"
