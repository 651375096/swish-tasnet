...
##############
def taiy_cmm(name):
    mix_path = "/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/0914/" + name + "1.csv"
    s1_path = "/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/0914/" + name + "1_4.csv"
    ...
    for aaa in range(aaa_cs):
        print(aaa_cs)
        np.savetxt("./voice_data/wav-cmm/tt/mix/" + name + str(aaa) + ".txt",
                   mix1[aaa * len(mix1) // aaa_cs:(aaa + 1) * len(mix1) // aaa_cs])
        np.savetxt("./voice_data/wav-cmm/tt/s1/" + name + str(aaa) + ".txt",
                   s11[aaa * len(mix1) // aaa_cs:(aaa + 1) * len(mix1) // aaa_cs])
        np.savetxt("./voice_data/wav-cmm/tt/s2/" + name + str(aaa) + ".txt",
                   s11[aaa * len(mix1) // aaa_cs:(aaa + 1) * len(mix1) // aaa_cs])
        np.savetxt("./voice_data/wav-cmm/tt/s3/" + name + str(aaa) + ".txt",
                   s11[aaa * len(mix1) // aaa_cs:(aaa + 1) * len(mix1) // aaa_cs])
