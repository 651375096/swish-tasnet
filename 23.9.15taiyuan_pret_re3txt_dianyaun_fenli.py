...
def handleBinarization(data,input_standard,deviation=0,way=0):
    ...
    elif input_standard =="pre_dianyuan":
        standard =np.max(bin_data)/5
...
def pre_out():
    ...
    fuxian_taiyuan(zscc_blue, fbl + "fuxian_blue1",10)
...
# subset_folder="/home/chenyang/wave-tasnet/voice_data/dataset_taiyuan/电源线在4通道"
# for _, folders, files in os.walk(subset_folder):
#     for file_name in sorted(files):
#         if file_name.endswith('.csv'):
#             fbl = file_name
...
hang_bin_standard="pre_dianyuan" ###决定二值化标准

wjj_temp="tmp-太原11"
pre_name="电源线tek0001ALL.csv7"
...
# zhen,pre_hang,pre_blue,pre_mix=read4CSV_5_11_18_24("/home/chenyang/wave-tasnet/voice_data/11.csv")
# pre_blue_original=pre_blue
pre_out()
