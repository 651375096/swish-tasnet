...
#
# database_path="/home/chenyang/各种数据集数据库/VGA/308VGA2通道"
# for _, folders, files in os.walk(database_path):
#     for track_name in sorted(folders):
#         subset_folder = op.join(database_path, track_name)
#         for _, folders, files in os.walk(subset_folder):
...
#############
fbl="111"
# load1="/home/chenyang/各种数据集数据库/VGA/308VGA2通道/9.1-48-4D-7E-BE-C6-AE/1024 768"

wjj2="5.4 4D-7E-BE-4E-02"
...
######
# #
# line_frame,blue_frame,jmu_frame=read4CSV("/home/chenyang/各种数据集数据库/VGA/308VGA/4.2 48-4D-7E-BE-CA-B9/1024x768.csv")
