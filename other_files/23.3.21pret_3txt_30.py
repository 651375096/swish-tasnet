...
#                     print("fbl",fbl)
#                     subset111_folder = op.join(subset_folder, file_name)
#                     print("subset111_folder",subset111_folder)
#                     fuxian_out1_path= op.join(out_path,fbl + "0" + "zhen.txt.txt")
#                     print("fuxian_out1_path",fuxian_out1_path)
#                     fuxian_out=np.loadtxt(fuxian_out1_path)
#                     line_frame, blue_frame, jmu_frame = read4CSV(subset111_folder)
#                     getDataset1_outprod()
...
# jmu_s1_path="./exp/tmp/out/signal/estimate/s1/1.1-48-4D-7E-BE-C8-651024-768.csv0zhen.txt.txt"
#
# hang_s3_path="./exp/tmp/out/signal/original/s3/1.1-48-4D-7E-BE-C8-651024-768.csv0zhen.txt.txt"
# jmu_frame=np.loadtxt(hang_s3_path)
# print(jmu_frame)
# line_frame=np.loadtxt(jmu_s1_path)
#
# pre_outDataset1()
