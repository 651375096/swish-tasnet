...
def handleBinarization(data,input_standard,deviation,way=0):
    ...
    if isNumber(input_standard):
        ...
        print("308VGA二值化standard=", standard)
    # if( way==1 ):
...
#############
fbl="111"
# mix0_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧混-帧.csv"
# mix1_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧混-混.csv"
#
# blue0_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧蓝-帧.csv"
# blue1_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧蓝-蓝.csv"
#
# hang0_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧行-帧.csv"
# hang1_path="F:\\2.1MAC48-4D-7E-BE-C8-65\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧行-行.csv"
#
...
######
allpath="/home/chenyang/各种数据集数据库/RigolDS1.csv"
