...
mix_path="../wave00/data/every_signal/中间集美大学/800_600_60.32Hz_通道0为帧同步_通道1为电磁信号.lvm"
blue_path="../wave00/data/every_signal/中间集美大学/800_600_60.32Hz_通道0为帧同步_通道1为蓝信号.lvm"
hang_path="../wave00/data/every_signal/中间集美大学/800_600_60.32Hz_通道0为帧同步_通道1为行信号.lvm"
jmu_frame=readLvm(mix_path)
blue_frame=readLvm(blue_path)
line_frame = readLvm(hang_path)
getDataset1()
