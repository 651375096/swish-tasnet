...
#
# fbl = "848"
# mix_path="../wave00/16data/848_480_60_集美大学_250MHz.lvm"
# blue_path="../wave00/16data/848_480_60_B_250MHz.lvm"
# hang_path="../wave00/16data/848_480_60_ZHENHANG_250MHz.lvm"
# jmu_frame=readLvm(mix_path)
# blue_frame=readLvm(blue_path)
# line_frame = readLvm(hang_path)
# getDataset1()
#
# fbl = "640"
# mix_path="../wave00/16data/640_480_60_集美大学_250MHz.lvm"
# blue_path="../wave00/16data/640_480_60_B_250MHz.lvm"
# hang_path="../wave00/16data/640_480_60_ZHENHANG_250MHz.lvm"
# jmu_frame=readLvm(mix_path)
# blue_frame=readLvm(blue_path)
# line_frame = readLvm(hang_path)
# getDataset1()

wave_wjm = "Linux三混合1024"
# mix_path="../wave00/16data/800_600_60_集美大学_250MHz.lvm"
# blue_path="../wave00/16data/800_600_60_B_250MHz.lvm"
# hang_path="../wave00/16data/800_600_60_ZHENHANG_250MHz.lvm"
mix_path="../wave00/data/every_signal/Linux三混合1024/1024 250mhz 0帧同步1混合信号.lvm"
blue_path="../wave00/data/every_signal/Linux三混合1024/1024 250mhz 0帧同步1蓝信号.lvm"
hang_path="../wave00/data/every_signal/Linux三混合1024/1024 250mhz 0帧同步1行同步.lvm"
jmu_frame=readLvm(mix_path)
blue_frame=readLvm(blue_path)
line_frame = readLvm(hang_path)
getDataset1()
