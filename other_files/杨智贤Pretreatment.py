...
def getDataset(group_str1,group_str2,subDir_wav,subDir_txt,bin_standard,replace_point,point_num,aim_value):
    print("二值化标准："+bin_standard)
    print("掩码替换-进行替换时定位点的值："+replace_point)
    print("掩码替换-替换的数量："+ point_num)
    print("掩码替换-替换值："+ aim_value)
    '''该函数用来获取数据集
    ...
    # group_str1=["D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_XIAMENJMU/20220401_1024-768zhen+b+ppt3.lvm",
    #                "D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_XIAMENJMU/20220401_1024-768zhen+fushe+ppt3.lvm",
    #                "D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_XIAMENJMU/20220401_1024-768zhen+hang+ppt3.lvm"]
    #
    # group_str2=["D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_Stroke/20220401_1024-768zhen+fushe+ppt4.lvm",
    #                "D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_Stroke/20220401_1024-768zhen+b+ppt4.lvm",
    #                "D:/learning/pythonLearn/pytorch/torch_test10.10/data/1024_768_Stroke/20220401_1024-768zhen+hang+ppt4.lvm"]

    #装入列表
    group_str_list=[group_str1,group_str2]
    print(group_str_list)
    #设置切分文件的计数编号
    s1_id_wav = 0
    s2_id_wav = 0
    mix_id_wav = 0
    ...
    for str in group_str_list:
        ...
        for fn in range(part_num):
            ...
            # bin_standard = "average"  # 进行bin_standard二值化的标准
