...
def handleBinarization(data,input_standard,deviation,way=0):
    ...
    elif input_standard == "308VGA":
        standard = (np.max(bin_data) / 3)
...
def getDataset1():
    ...
    for zhen_cs in range(part_num):
        ...
        # 获取第一帧的信号
        print("开始",jmu_info[fn]['start'],"结束",jmu_info[fn]['start'] + max_len)
        ...
        huatu(line, "line_signal")
        print("line0",len(line))
...
mix0_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧混-帧.csv"
mix1_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧混-混.csv"

blue0_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧蓝-帧.csv"
blue1_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧蓝-蓝.csv"

hang0_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧行-帧.csv"
hang1_path="F:\\308VGA2通道\\2.1MAC48-4D-7E-BE-C8-65\\1024-768\\帧行-行.csv"
